...
func (repo CategoryRepository)  List(req *query.ListQuery) (Categories []*model.CategoryResult, err error){
	...
	err = repo.DB.Raw("SELECT c1.category_id as c1_category_id,c1.name as c1_name,c1.desc as c1_desc,c1.order as c1_order,c1.parent_id as c1_parent_id," +
							"c2.category_id as c2_category_id,c2.name as c2_name,c2.desc as c2_desc,c2.order as c2_order,c2.parent_id as c2_parent_id," +
							"c3.category_id as c3_category_id,c3.name as c3_name,c3.desc as c3_desc,c3.order as c3_order,c3.parent_id as c3_parent_id,c3.is_delete as c3_is_delete" +
							"FROM category c1 join category c2 on c1.category_id = c2.parent_id join category c3 on c2.category_id = c3.parent_id ").Find(&list).Error
	if err != nil{
		return nil,err
	}
	return list,nil
